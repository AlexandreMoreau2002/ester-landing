...
const TRANSLATIONS = {
  ...
  fr: {
    ...
    'contact.prenom.label':      'Prénom',
    'contact.prenom.placeholder':'Votre prénom',
    'contact.cv.label':             'Pièce jointe',
    'contact.cv.label.candidature': 'CV, lettre de motivation, portfolio…',
    'contact.cv.btn':               'Choisir un fichier',
    'contact.cv.empty':             'Aucun fichier choisi',
    'contact.cv.hint':              'Formats acceptés : PDF, Word, Excel, images — max 10 Mo.',
    'contact.soc.label':      'Entreprise',
    'contact.soc.placeholder':'Nom de votre entreprise',
  ...
  en: {
    ...
    'contact.nom.label':      'Last name',
    'contact.nom.placeholder':'Your name',
    'contact.prenom.label':      'First name',
    'contact.prenom.placeholder':'Your first name',
    'contact.cv.label':             'Attachment',
    'contact.cv.label.candidature': 'CV, cover letter, portfolio…',
    'contact.cv.btn':               'Choose a file',
    'contact.cv.empty':             'No file chosen',
    'contact.cv.hint':              'Accepted formats: PDF, Word, Excel, images — max 10 MB.',
    'contact.soc.label':      'Company',
    'contact.soc.placeholder':'Your company',
    'contact.email.label':    'Email',
